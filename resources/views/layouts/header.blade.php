<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> Khóm 8, Phường 5, Tp.Cà Mau</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0856141256</a></li>
					</ul>
				</div>
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						<li><a href="#"><i class="fa fa-user"></i>Tài khoản</a></li>
						<li><a href="http://127.0.0.1:8000/signup">Đăng kí</a></li>
						<li><a href="http://127.0.0.1:8000/signin">Đăng nhập</a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="http://127.0.0.1:8000/" id="logo"><img src="newpic/Logo/gearlogo.png" width="200px" alt=""></a>
				</div>
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="http://127.0.0.1:8000/contacts">Liên hệ</a></li>
					</ul>
					<div class="clearfix"></div>
				</nav>
			</div> <!-- .container -->
